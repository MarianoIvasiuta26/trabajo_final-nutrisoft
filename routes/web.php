...
*/
    ...
    Route::post('mi-seguimiento.registrarAlimentoConsumido', [SeguimientoPacienteController::class, 'registrarConsumo'])->name('mi-seguimiento.registrarAlimentoConsumido');
