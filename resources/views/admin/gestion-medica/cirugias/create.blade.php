...
@section('content')
    <div class="card card-dark">
        ...
        <div class="card-body">
            <form action="{{ route('gestion-cirugias.store') }}" method="POST">
                @csrf

                <div class="mb-3">
                    <label for="cirugia" class="form-label">Cirugía</label>
                    <input type="text" name="cirugia" id="cirugia" class="form-control" tabindex="2">
                </div>
                <div class="mb-3">
                    <label for="grupo_cirugia">Grupo Cirugía</label>
                    <input type="text" name="grupo_cirugia" id="grupo_cirugia" class="form-control" tabindex="3">
                </div>
                {{--<div class="mb-3">
                ...
                <a href="{{ route('gestion-cirugias.index') }}" class="btn btn-secondary" tabindex="7">Cancelar</a>
