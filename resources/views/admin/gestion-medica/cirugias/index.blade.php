...
@section('content')
    ...
    <div class="container mt-3">
        <table id="tabla-cirugias" class="table table-dark table-striped mt-4">
            <thead>
                <tr>
                    <th scope="col">ID</th>
...
@section('js')
    ...
    <script>
        $(document).ready(function(){
            var table = $('#tabla-cirugias').DataTable({
                responsive: true,
                autoWidth: false,
                "lengthMenu": [[5, 10, 50, -1], [5, 10, 50, "Todos"]],
                "language": {
                    "lengthMenu": "Mostrar _MENU_ cirugias por página",
                    "zeroRecords": "No se encontró ninguna cirugía",
                    "info": "Mostrando la página _PAGE_ de _PAGES_",
                    "infoEmpty": "No hay registros de cirugías",
                    "infoFiltered": "(filtrado de _MAX_ cirugías totales)",
                    "search": "Buscar:",
                    "paginate": {
                        "first": "Primero",
                        "last": "Último",
            ...
            deleteButtons.forEach(function (button) {
                button.addEventListener('click', function () {
                    ...
                    swalWithBootstrapButtons.fire({
                        title: '¿Estás seguro?',
                        text: 'Esta acción eliminará el registro de cirugía.',
                        icon: 'warning',
