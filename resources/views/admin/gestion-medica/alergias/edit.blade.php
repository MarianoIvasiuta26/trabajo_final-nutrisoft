...
@section('content')
    <div class="card card-dark mt-3">
        <div class="card-header">
            <h5>Editar Alergia</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('gestion-alergias.update', $alergia->id) }}" method="POST">
                @csrf
                @method('PUT')

                <div class="mb-3">
                    <label for="alergia" class="form-label">Alergia</label>
                    <input value="{{$alergia->alergia}}" type="text" name="alergia" id="alergia" class="form-control" tabindex="2">
                </div>
                <div class="mb-3">
                    <label for="grupo_alergia">Grupo Alergia</label>
                    <input value="{{$alergia->grupo_alergia}}" type="text" name="grupo_alergia" id="grupo_alergia" class="form-control" tabindex="3">
                </div>
                {{--<div class="mb-3">
                ...
                <div>
                    <form action="{{ route('gestion-alergias.index') }}">
                        @csrf
