...
@section('title', 'Agregar nueva Alergia')

@section('content_header')
    <h1>Agregar nueva Alergia</h1>
@stop
...
@section('content')
    <div class="card card-dark">
        ...
        <div class="card-body">
            <form action="{{ route('gestion-alergias.store') }}" method="POST">
                @csrf

                <div class="mb-3">
                    <label for="alergia" class="form-label">Alergia</label>
                    <input type="text" name="alergia" id="alergia" class="form-control" tabindex="2">
                </div>
                <div class="mb-3">
                    <label for="grupo_alergia">Grupo Alergia</label>
                    <input type="text" name="grupo_alergia" id="grupo_alergia" class="form-control" tabindex="3">
                </div>
                {{--<div class="mb-3">
                ...
                <a href="{{ route('gestion-alergias.index') }}" class="btn btn-secondary" tabindex="7">Cancelar</a>
