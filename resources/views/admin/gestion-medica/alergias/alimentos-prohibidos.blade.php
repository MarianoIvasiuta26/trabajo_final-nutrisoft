...
@section('content')
    ...
    <div class="card card-dark">
        ...
        <div class="card-body">
            ...
            <form action="{{route('prohibiciones-alergias.store')}}" method="POST">
                @csrf
                ...
                <div class="row mt-3">
                    <div class="col">
                        <div class="float-right">
                            <button type="button" class="btn btn-success asociar-button">Prohibir alimento en alergia</button>
                        </div>
                    </div>
                </div>
                            ...
                            <tr>
                                ...
                                <td>
                                    @foreach ($alergias as $alergia)
                                        @if ($alergia->id == $prohibido->alergia_id)
                                            {{ $alergia->alergia }}
                                        @endif
                                    @endforeach
                                </td>
                                ...
                                <td>
                                    <div>
                                        <form action="{{ route('prohibiciones-alergias.edit', $prohibido->id) }}" method="GET"style="display: inline;">
                                            @csrf
                                            <button type="submit" class="btn btn-warning">
                                                <span class="far fa-edit"></span>
                                            </button>
                                        </form>
                                        <form action="{{ route('prohibiciones-alergias.destroy', $prohibido->id) }}" method="POST" style="display: inline;">
                                            @csrf
                                            @method('DELETE')
