...
@section('content_header')
    <h1>Agregar nueva Intolerancia</h1>
@stop

@section('content')
    <div class="card card-dark">
        <div class="card-header">
            <h5>Nueva Intolerancia</h5>
        </div>
        <div class="card-body">
            <form action="{{ route('gestion-intolerancias.store') }}" method="POST">
                @csrf

                <div class="mb-3">
                    <label for="intolerancia" class="form-label">Intolerancia</label>
                    <input type="text" name="intolerancia" id="intolerancia" class="form-control" tabindex="2">
                </div>
                {{--<div class="mb-3">
