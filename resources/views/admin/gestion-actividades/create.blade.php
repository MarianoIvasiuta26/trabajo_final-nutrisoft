...
@section('title', 'Agregar nueva Actividad')
...
@section('content')
    ...
    <div class="card card-dark mt-3">
        ...
        <div class="card-body">
            ...
            <form action="{{route('gestion-actividades.store')}}" method="POST">
                @csrf

                <div class="mb-3">
                    <label for="actividad" class="form-label">Actividad</label>
                    <input type="text" name="actividad" id="actividad" class="form-control" tabindex="2" value="{{old('actividad')}}">
