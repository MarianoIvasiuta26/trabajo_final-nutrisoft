                                ...
                                @foreach ($consultas as $consulta)
                                    @if ($consulta->turno_id == $turno->id)
                                        <tr>
                                            ...
                                            <td>{{ $consulta->peso_actual }} (kg)</td>
                                        </tr>

                                        <tr>
                                            <th scope="col">Altura Actual</th>
                                            <td>{{ $consulta->altura_actual }} (cm)</td>
                                        </tr>

                                        <tr>
                                            <th scope="col">Circunferencia de Muñeca Actual</th>
                                            <td>{{ $consulta->circunferencia_munieca_actual }} (cm)</td>
                                        </tr>
                                            <th scope="col">Circunferencia de Cintura Actual</th>
                                            <td>{{ $consulta->circunferencia_cintura_actual }} (cm)</td>
                                        </tr>

                                        <tr>
                                            <th scope="col">Circunferencia de Cadera Actual</th>
                                            <td>{{ $consulta->circunferencia_cadera_actual }} (cm)</td>
                                        </tr>

                                        <tr>
                                            <th scope="col">Circunferencia de Pecho Actual</th>
                                            <td>{{ $consulta->circunferencia_pecho_actual }} (cm)</td>
                                        </tr>
                                    @else
                                        <tr>
                                            <th scope="col">Peso Actual</th>
